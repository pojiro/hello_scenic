defmodule HelloScenic.Component.Nav do
    ...
    graph =
      ...
      |> dropdown(
        {[
           ...
           {"Fills", HelloScenic.Scene.Fills},
           {"Strokes", HelloScenic.Scene.Strokes},
           {"Components", HelloScenic.Scene.Components},
           {"Transforms", HelloScenic.Scene.Transforms},
           {"Sprites", HelloScenic.Scene.Sprites}
         ], current_scene},
        id: :nav,
        translate: {90, 10}
      )
